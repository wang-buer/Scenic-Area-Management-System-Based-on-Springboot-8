...
public class DiscussjingquxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjingquxinxiEntity discussjingquxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjingquxinxiEntity discussjingquxinxi, HttpServletRequest request){
        EntityWrapper<DiscussjingquxinxiEntity> ew = new EntityWrapper<DiscussjingquxinxiEntity>();
		PageUtils page = discussjingquxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussjingquxinxi), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjingquxinxiEntity> wrapper = new EntityWrapper<DiscussjingquxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjingquxinxiService.selectCount(wrapper);
